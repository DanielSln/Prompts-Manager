...
const elements = {
  ...
  btnClearSearchIcon: document.getElementById("btn-clear-search-icon"),
  btnClearSearchText: document.getElementById("btn-clear-search-text"),
  btnClearSearchWrapper: document.getElementById("btn-clear-search-wrapper"),
  btnClearSearchWrapper: document.getElementById("btn-clear-search-wrapper"),
  btnClearSearchWrapper: document.getElementById("btn-clear-search-wrapper"),
};
...
function createPromptItem(prompt) {
  return `
      ...
      <button class="btn-icon" title="Remover">
        <img
          src="assets/remove.svg" alt="Remover" class="icon icon-trash" data-action="remove"/>
      </button>
    </li>
  `;
}
